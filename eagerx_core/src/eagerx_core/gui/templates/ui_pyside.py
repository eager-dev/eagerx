"""
 Mostly copy paste from https://github.com/pyqtgraph/pyqtgraph/blob/master/pyqtgraph/flowchart/FlowchartCtrlTemplate_pyside.py
"""
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.showChartBtn.setText(QtGui.QApplication.translate("Form", "Show Graph", None, QtGui.QApplication.UnicodeUTF8))
        self.checkValidityBtn.setText(QtGui.QApplication.translate("Form", "Check Validity", None, QtGui.QApplication.UnicodeUTF8))
        self.showCompatibleBridgesBtn.setText(QtGui.QApplication.translate("Form", "Compatible Bridges", None, QtGui.QApplication.UnicodeUTF8))
