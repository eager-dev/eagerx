...
if __name__ == '__main__':
    ...
    N4 = RxNodeParams.create('N4', 'eagerx_core', 'process',   rate=4, single_process=sp, outputs={'out_1': 'N4/P4'}, output_converters={'out_1': IntUInt64Converter})
    ...
    # Connect nodes
    connections = [{'source': (viper, 'sensors', 'N7'), 'target': (observations, 'obs_1', 'all'), 'delay': 0.0},
